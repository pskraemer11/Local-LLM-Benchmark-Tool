...
Stand: 2026-08-05. Legende: [ ] offen, [~] in Arbeit, [x] erledigt/geprüft.

## Aktive Punkte

- [~] **1. Planung.md anlegen** — diese Datei (Auftrag vom 05.08.).
...
- [ ] **9. Quarantäne-Ordner** — 137 Waisen-Configs liegen in `~\.lmstudio\.internal\user-concrete-model-default-config\_quarantine_orphans_20260805\`; Nutzer will Quarantäne als Papierkorb dauerhaft behalten (kein Löschen).
