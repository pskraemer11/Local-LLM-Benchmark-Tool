...
Generated automatically: 2026-08-11 11:42:08
...
50 entries have no local hub model.yaml (no comparison possible, manual GGUF check required):
...
- **crucible-labs/gemma4-26b-a4b-reap-25**: no hub model.yaml found (registry has GGUF size)
