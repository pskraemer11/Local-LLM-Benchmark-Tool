...
# ── LM-Eval Proxy ──────────────────────────────────────────────
# Routes lm_eval's OpenAI Chat Completions requests through a local proxy.
# The proxy now forwards requests directly to the upstream server (no translation).
# Only needed when lm_eval needs a different base_url than the main API.
...
CUSTOM_BENCHMARK_SCRIPT = os.path.join(BASE_DIR, "custom_benchmark.py")
