...
| 14.08. | gesamt | **Verifikationslauf 3 (09:02, PID 7120) komplett durchgelaufen** (alle 5 Benchmarks inkl. Agentic): DS1000 3.5%, CoderEval 90.0%, HumanEval+ 0.600, MBPP+ 0.800 (nach Subset-Eval-Fix, berechnet aus Lauf-3-Samples), Agentic ok. HumanEval+-Stichprobe: 4/10 Lösungen leer (Modell liefert bei `temp=1.0` sporadisch leeren Content — dokumentiert in `doc-git/Model Specific Hints/Gemma 4 - Consolidated Model Hints_en.md`); MBPP+ 0/10 leer. Commit `47e044e` (SIGALRM-Attribut, 2. Iteration) + Subset-Eval-Commit |
